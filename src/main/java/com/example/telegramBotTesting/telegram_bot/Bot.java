    ...
    private String parseMessage(String textMsg) {
        ...
        switch (textMsg) {
            case START: case MENU: case "/Net":
                response = "Привет! :)\n\n" +
                        "Бот был создан для поиска в среднем 5 дефектов в день, " +
                        "чтобы находить больше полезных дефектов и приносить поьзу приложению!\n\n" +
                        "Выбери раздел для получении проверки для конкретного функционала!\n\n " +
                        "1. Жми " + APIASSERT + " для получения проверки для API.\n " +
                        "2. Жми " + REGISTERFORMASSERT + " для получения проверки для формы регистрации.\n " +
                        "3. Жми " + DOCUMENTATIONASSERT + " для получения проверки для документации.\n" +
                        "4. Жми " + AUTOTESTINFORMATION + " для получения проверки для автотестов.\n" +
